...
import org.sims.web.filter.FormFilter;
...
@WebAppConfiguration
@ContextConfiguration(locations = {"classpath:spring.xml", "classpath:spring/spring-dao.xml"})
public class LoginControllerTest {
    ...
    public void loginTest() throws Exception{
        ...
        *   2.表单的内容与 org.sims.form.LoginForm 类的各个field相对应
